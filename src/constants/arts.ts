...
const paintings: I_Art[] = [
  {
    ...
    fileIds: ["/teethPortal_mobile/images/онаещеи.png"],
  },
  {
    ...
    fileIds: ["/teethPortal_mobile/images/ядовитая.png"],
  },
  {
  ...
  },
  {
    ...
    material: "акрил",
    base: "холст на картоне",
    fileIds: ["/teethPortal_mobile/images/лунное_затмение.png"],
  },
  {
    title: "летний день",
    year: "2025",
  ...
  {
    title: "18: роза / хризантема / ласточка",
    year: "2024-2025",
    size: "10x10",
    material: "акрил, масло",
    base: "холст на картоне",
    fileIds: [
      "/teethPortal_mobile/images/18 роза 1.png",
      "/teethPortal_mobile/images/18_хризантема.png",
      "/teethPortal_mobile/images/ласточка.png",
    ],
  },
  {
    title: "энергия",
